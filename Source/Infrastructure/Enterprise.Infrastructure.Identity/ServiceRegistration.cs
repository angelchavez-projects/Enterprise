                ...
                .AddJwtBearer(o =>
                {
                    ...
                    o.Events = new JwtBearerEvents()
                    {
                        OnChallenge = async context =>
                        {
                            ...
                            await context.Response.WriteAsJsonAsync(Result.Failure(new Error(ErrorCode.AccessDenied, "You are not Authorized")));
                        },
                        OnForbidden = async context =>
                        {
                            context.Response.StatusCode = 403;
                            await context.Response.WriteAsJsonAsync(Result.Failure(new Error(ErrorCode.AccessDenied, "You are not authorized to access this resource")));
                        },
